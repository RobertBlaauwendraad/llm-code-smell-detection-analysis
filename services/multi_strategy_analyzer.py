...
class MultiStrategyAnalyzer:
    def __init__(self, strategies, min_id=None):
        """
    ...
    def analyze_all_strategies(self, sample_ids):
        for strategy_name, assistant_id in self.strategies.items():
            ...
            analyzer = SingleStrategyAnalyzer(strategy_name, assistant_id, results_file, self.min_id)
            ...
            analyzer.view_heatmaps(title=f'Results Heatmaps ({strategy_name})')